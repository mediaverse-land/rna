...
> = {
  ...
  BEST_VIDEOS: {
    icon: <ICON_TOP_TABBAR_VIDEO_ACTIVE_SVG width={16} height={16} style={viewAllStyles.icon} />,
    title: 'Best Videos',
    url: 'videos/most-viewed',
    ListComponent: ViewAllVideoList,
  },
  MOST_VIEWD_IMAGES: {
    icon: <ICON_TOP_TABBAR_IMAGE_ACTIVE_SVG width={16} height={16} style={viewAllStyles.icon} />,
    title: 'Most viewed',
    url: 'images/most-viewed',
    ListComponent: ViewAllImageList,
  },
  TOP_TEXTS: {
    icon: <ICON_TOP_TABBAR_TEXT_ACTIVE_SVG width={16} height={16} style={viewAllStyles.icon} />,
    title: 'Top texts',
    url: 'texts/daily-recommended',
    ListComponent: ViewAllTextsList,
  },
  BEST_SONGS: {
    icon: <ICON_TOP_TABBAR_SOUND_ACTIVE_SVG width={16} height={16} style={viewAllStyles.icon} />,
    title: 'Best songs',
