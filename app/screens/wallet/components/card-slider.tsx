    ...
    >
      ...
      >
        ...
        <Box width={'100%'} height={'100%'}>
          <Box width="100%" paddingTop={34} justifyContent="center" alignItems="center">
            <Image
              source={{
                uri: STRIPE_IMG,
              }}
            ...
            />
            <Text fontSize={14} fontWeight={400} lineHeight={24} color={theme.color.light.WHITE}>
              Paypal
            </Text>
          </Box>
          <Box width="100%" position="absolute" bottom={1}>
            ...
            <Box alignItems="center" marginBottom={24}>
              <Text fontSize={16} fontWeight={600} lineHeight={24} color={theme.color.light.WHITE}>
                **** **** **** 3054
              </Text>
            </Box>
