...
export function Login() {
    const [currentWindow, setCurrentWindow] =
        useState<'INSERT_PHONE' | 'SEND_CODE' | 'USER_PASS'>('INSERT_PHONE');

    const setCurrentWindowHandler = (window: 'INSERT_PHONE' | 'SEND_CODE' | 'USER_PASS') => {
        ...
        <>
            <Box height='60%' marginTop={150} alignItems='center'>
                <Text
                    ...
                    fontSize={12}
                    fontWeight={600}
                >Insert your username and password</Text>
