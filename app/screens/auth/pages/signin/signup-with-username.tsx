...
export const SignUpWithUsername: FC<Props> = ({ height, setWindowHandler, intialWindw, initial__token }) => {
    const [currentWindow, setCurrentWindow] =
        useState<SignUpWithUsernameWindows>(intialWindw ? intialWindw : INSERT_PHONE);
