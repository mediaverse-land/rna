...
import { activeDisableOnIntractions, deActivrDisableOnIntractions } from '../../slices/tour.slice';
...
export function AppsPageAllScreen({ navigation }: { navigation: UseNavigationType }) {
