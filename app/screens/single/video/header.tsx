...
import { ICON_ARROW_LEFT_WHITE, ICON_VIDEO_PLAY, ICON_VIDEO_WHITE } from '../../../constaints/icons';
...
const videoThumbnailCoverPath = 'https://s3-alpha-sig.figma.com/img/43f5/fd0b/108d3af19c1494f0e588166ba567c70c?Expires=1685923200&Signature=i9oLIJQZlXtXY1z~aRULqWji8zHBjQDuL9mxah4gNYiJZAiitaxRfnzOia0kHfKg-CNPPh1boVuw2bPH9GL~RT-bsbhhSAmk6vgEFM-knbhi2~nKwP7ySw93ArhjHgazfIzrsHvR61sdhILZP~aM5SBhGHHFbLpKJm98KoSrwrEcu-SYKMIwuMNd-g1DcKs-2Nrw27i1k4om9B41~WgVC9ZTXZaQVGli~BCu1YFJ3M2hJjQtqIRVJsL3kpT4E21v0L0e~1UBeriDLWya-JByBokcN3Elb54jYedLzwuEpQnct81sNrDh7SCM8YxUbx4RjpHXmPgwJh4vDAfkSesSmA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4'

const { BackButton } = SingleVideoPageComponents

/**
 * 
 * @returns header component including, video thumbnail cover, go back button and video title
*/
export function SingleVideoHeader({ goBackHandler }: Props) {

    const thumbnailCoverGradient = <Image
        source={{
