...
export function CreateTextContent() {
    ...
    function createTagHandler(event: NativeSyntheticEvent<TextInputKeyPressEventData>) {
        ...
        if (key === "" || key === " ") {
            ...
            if (cuurrentTag.charAt(0) === "#") {
                ...
                if (trimmedTag === ".") {
                    setHashtags([...hashTags, cuurrentTag.slice(0, cuurrentTag.length - 2)])
                    setCurrentTag('');
                    return;
                }
        ...
        <PaddingContainer>
            ...
            <View>
                <Input
                    ...
                    multiline={true}
                    placeholderTextColor={color.light.GRAY}
                    style={{ height: textInputHeight, textAlignVertical: 'top' }}
                    onContentSizeChange={(event) => {
                        getInputContentHeight(event.nativeEvent.contentSize.height);
                    }}
                />
            </View>
        </PaddingContainer>
