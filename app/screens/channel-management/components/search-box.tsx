...
export const ChannelManagementSearchBox = () => {
  return (
    <Box width={WINDOW_WIDTH - 48} height={48} marginTop={32} position="relative" left={24}>
      <TextInput style={styles.textInput} placeholder="Search" placeholderTextColor="#83839C" />
