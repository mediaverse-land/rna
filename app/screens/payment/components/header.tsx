...
export function PaymentContentHeader({
  goBackHandler,
  thumbnail,
  title,
  price,
          ...
          <Box position="relative" zIndex={2} padding={16}>
            <Box width="100%" height={72} direction="row">
              <Box width={72} height={72}>
                ...
                <Image
                  source={{
                    uri: thumbnail || SINGLE_TEXT_COVER_GRAIDENT,
                  }}
                  style={{
                    width: 72,
                    height: 72,
              ...
              <Box flex={1} marginLeft={16} justifyContent="flex-start">
                <Text
                ...
                <Box direction="row" alignItems="center" marginTop={18}>
                  <ICON_EYE_GRAY
                    style={{
                      width: 19,
                      height: 12,
