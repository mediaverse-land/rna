                    ...
                    <TouchableWithoutFeedback onPress={this.toggleOpen}>
                        <View style={[styles.button, styles.actionBtn]}>
                            <Image
                                ...
                                resizeMode="contain"
                                source={{
                                    uri: 'https://icon-library.net/images/android-plus-icon/android-plus-icon-0.jpg'
                                }}
                            />
                        </View>
                    </TouchableWithoutFeedback>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Image
                                source={{
                                    uri: 'https://serfob.s3.amazonaws.com/media/settings-icon-png82e-4c02-9f9a-51398c8713ae.png'
                                }}
                                style={{
                                    marginHorizontal: 16,
                                    width: 30,
