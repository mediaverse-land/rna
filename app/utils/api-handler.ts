...
export class ApiHandler {
  async post(endpoint: string, data: object, config?: object) {
    ...
    try {
      const request = await axios.post(`${BASE_URL}${endpoint}`, data, config);
  ...
  async put(endpoint: string, data: object, config?: object) {
    ...
    try {
      const request = await axios.put(`${BASE_URL}${endpoint}`, data, config);
  ...
  async patch(endpoint: string, body: any, config?: object) {
    ...
    try {
      const request = await axios.patch(`${BASE_URL}${endpoint}`, body, config);
  ...
  async delete(endpoint: string, config?: object) {
    ...
    try {
      const request = await axios.delete(`${BASE_URL}${endpoint}`, config);
