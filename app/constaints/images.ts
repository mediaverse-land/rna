...
export const IMAGE_THUMBNAIL_PLACEHOLDER = imageUriResolver(
  IMAGE_THUMBNAIL_PLACEHOLDER_PNG
);
export const VIDEO_THUMBNAIL_PLACEHOLDER = imageUriResolver(
  VIDEO_THUMBNAIL_PLACEHOLDER_PNG
);
export const AUDIO_THUMBNAIL_PLACEHOLDER = imageUriResolver(
  AUDIO_THUMBNAIL_PLACEHOLDER_PNG
);
...
export const DAILY_RECOMMENDED_IMG_ONE = imageUriResolver(
  DAILY_RECOMMENDED_IMG_ONE_PNG
);
export const DAILY_RECOMMENDED_IMG_TWO = imageUriResolver(
  DAILY_RECOMMENDED_IMG_TWO_PNG
);
export const DAILY_RECOMMENDED_IMG_THREE = imageUriResolver(
  DAILY_RECOMMENDED_IMG_THREE_PNG
);
