...
//   const _renderItem = ({ row }: { row: Image[] }) => {
//     return (
//       <Box width={ROW_WIDTH} height={ROW_WIDTH} hasBlackBorder>
//         <Box id="top" width="100%" hasBlackBorder height={"50%"}></Box>
//         <Box id="bottom" width="100%" hasBlackBorder height={50}></Box>
//       </Box>
//     );
//   };
