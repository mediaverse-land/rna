                    ...
                    <RowAlignCenter >
                        <View style={{ paddingTop: 18 }}>
                            <Image
                                ...
                                source={{ uri: 'https://www.figma.com/file/PjruT7z5jL7KsoUn0tQadE/image/8b3801231b3bc56d8d3d28d35c9776e478125bae?fuid=843972259226061773' }}
                            />
                        </View>
                        <CommentCardComponents.TextBoxWrapper style={{ flex: 1, width: '100%' }}>
